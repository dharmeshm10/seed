...
import 'package:seed/common/constants/http_constants.dart';
import 'package:seed/common/utils/http_utils.dart';
...
class HttpClient {
  ...
  factory HttpClient.setTodoAPIhost() => HttpClient(
  ...
  dynamic getImage(String url) async {
    final Response response = await client.get(url as Uri);
    return response;
  }
}
